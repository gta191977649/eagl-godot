...
func _config_from_row(row: Dictionary, drive_type: String, globalb_path: String):
	...
	config.hp2_front_tire_0x1ac = _row_float(globalb_row, 0x1ac, config.hp2_front_tire_0x1ac)
	config.hp2_front_tire_0x1b0 = _row_float(globalb_row, 0x1b0, config.hp2_front_tire_0x1b0)
	...
	config.hp2_rear_tire_0x1cc = _row_float(globalb_row, 0x1cc, config.hp2_rear_tire_0x1cc)
	config.hp2_rear_tire_0x1d0 = _row_float(globalb_row, 0x1d0, config.hp2_rear_tire_0x1d0)
	config.hp2_rear_tire_0x1d4 = _row_float(globalb_row, 0x1d4, config.hp2_rear_tire_0x1d4)
	config.hp2_rear_tire_0x1d8 = _row_float(globalb_row, 0x1d8, config.hp2_rear_tire_0x1d8)
	config.hp2_rear_tire_0x1dc = _row_float(globalb_row, 0x1dc, config.hp2_rear_tire_0x1dc)
	...
	config.hp2_row_0x300 = _row_float(globalb_row, 0x300, config.hp2_row_0x300)
	config.hp2_row_0x304 = _row_float(globalb_row, 0x304, config.hp2_row_0x304)
	config.hp2_row_0x308 = _row_float(globalb_row, 0x308, config.hp2_row_0x308)
	config.hp2_row_0x310 = _row_float(globalb_row, 0x310, config.hp2_row_0x310)
	config.hp2_row_0x314 = _row_float(globalb_row, 0x314, config.hp2_row_0x314)
	config.hp2_row_0x318 = _row_float(globalb_row, 0x318, config.hp2_row_0x318)
	config.hp2_row_0x31c = _row_float(globalb_row, 0x31c, config.hp2_row_0x31c)
	config.hp2_row_0x320 = _row_float(globalb_row, 0x320, config.hp2_row_0x320)
	return config

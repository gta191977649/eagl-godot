...
@export var engine_torque_samples = PackedFloat32Array([0.35, 0.49, 0.55, 0.60, 0.62, 0.61, 0.58, 0.365, 0.30])
@export var engine_friction_samples = PackedFloat32Array([0.55, 0.575, 0.60])
